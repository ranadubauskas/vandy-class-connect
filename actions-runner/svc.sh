...
SVC_NAME="actions.runner.ranadubauskas-vandy-class-connect.Ranas-MacBook-Pro-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ranadubauskas-vandy-class-connect.Ranas-MacBook-Pro-2)"
