...
function CourseDetailPageComponent() {
  ...
  // Filtering reviews based on selected professor and rating
      ...
      <div className="min-h-screen p-6 sm:p-8 lg:p-10">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <div className="flex flex-row flex-nowrap justify-between items-center mb-4 overflow-x-auto">
            ...
            <button
              onClick={toggleTutors}
              className="flex-shrink-0 flex flex-col items-center space-y-1 focus:outline-none mb-4 lg:mb-0"
            >
            ...
            <div className="flex-shrink-0 flex flex-col items-center flex-grow mb-4 lg:mb-0">
